...
{
    public class PortalLoggerSettings
    {
        ...
        public PortalLogServerConnectionSettings logServerConnectionSettings { get; set; }
        ...
        public PortalSumoLogicConnectionSettings sumoLogicConnectionSettings { get; set; }
        public bool logToSumoLogic { get; set; }
        public int sumoLogicLogLevel { get; set; }
        public int settingsType { get; set; }
    }

    public class PortalLogServerConnectionSettings
    {
    ...
    {
        public PortalLoggerSettings loggerSettings { get; set; }
    ...
    public class PortalSumoLogicConnectionSettings
    {
        public string url { get; set; }
