...
{
    public class SchedulingLoggerSettings
    {
        ...
        public SchedulingLogServerConnectionSettings logServerConnectionSettings { get; set; }
        ...
        public SchedulingSumoLogicConnectionSettings sumoLogicConnectionSettings { get; set; }
        public bool logToSumoLogic { get; set; }
        public int sumoLogicLogLevel { get; set; }
        public int settingsType { get; set; }
    }

    public class SchedulingLogServerConnectionSettings
    {
    ...
    public class Scheduling_server
    {
        public bool disableCompression { get; set; }
        public bool installed { get; set; }
        public string lastError { get; set; }
        public string lastErrorDetails { get; set; }
        public SchedulingLoggerSettings loggerSettings { get; set; }
    ...
    public class SchedulingSumoLogicConnectionSettings
    {
        public string url { get; set; }
